...
function sendEmailToAdmin() {
    ...
    try {
        ...
        $mail->Body    = "<p>A new minor repair request has been submitted by " . $_POST['name'] . "</p><p><a href='https://tupcauxiliary.com/Auxiliary/admin/minor-repair.php'>Click here to view the request.</a></p>";
